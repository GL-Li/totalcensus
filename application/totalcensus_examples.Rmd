...
```{r}
computer <- read_acs1year(
    year = 2016,
    states = states_DC,
    table_contents = c(
        "total_household = B28001_001",
        "has_computer = B28001_002",
        "desktop_laptop = B28001_003",
        "desktop_laptop_only = B28001_004",
        "smart_phone = B28001_005",
        "smart_phone_only = B28001_006",
...
ratio <- mutate(
    computer, ratio_no_computer = 100 * (no_computer / total_household)
) %>%
    filter(GEOCOMP %in% c("urban", "rural"))
