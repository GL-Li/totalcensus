...
- with_margin: whether to read magin of error of the estimate.
- dec_fill: whether to fill geo_headers codes with data from decennial census. The codes in ACS summary file are often incomplete. To use decennial census 2010 data to fill the missing values, set the argment to "dec2010".
...
Below is the code that gives what we want. The first time you use `read_xxxx()` functions to read data files, you will be asked to download data generated from decenial census 2010 and summary files required for this function call, in this case, 2016 ACS 1-year summary files. Choose 1 to continue. 
