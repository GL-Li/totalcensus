...
-   with\_margin: whether to read magin of error of the estimate.
-   dec\_fill: whether to fill geo\_headers codes with data from
    ...
    values, set the argment to “dec2010”.
...
download data generated from decenial census 2010 and summary files
